// Regula Falsi method for solving x^2 - 4x - 10
...
void find_root(float n1, float n2, int epochs,int left)
{
    ...
    while(epochs--)
    {
        n3 = (float)((n2*sign_value(n1)) - (n1*sign_value(n2))) / (sign_value(n1) - sign_value(n2));
...
int main() {
    ...
    printf("\n\n***********************************************************************\n");
    printf("Calculating through Regula-Falsi method for right root\n");
    printf("***********************************************************************\n");
    ...
    printf("\n\n***********************************************************************\n");
    printf("Calculating through Regula-Falsi for left root\n");
    printf("***********************************************************************\n");
    printf("Initial guesses are: %f and %f \n",n1_left,n1_right);
    printf("***********************************************************************\n");
    printf("Iteration \t result after iteration \t Actual\n");
